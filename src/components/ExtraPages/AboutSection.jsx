  ...
  return (
    <div className="hero mt-8 lg:mt-16 dark:text-black">
      <div className="hero-content flex-col lg:flex-row max-w-6xl mx-auto">
        <img src={img} className="sm:w-1/2 lg:h-[280px] rounded-lg mt-6" />
        <div className="">
          ...
          <p className="py-6">
            Welcome to MediCorner, your trusted online pharmacy. We are
            ...
            everybody. At MediCorner, we prioritize customer satisfaction and
